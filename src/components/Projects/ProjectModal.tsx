    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-card border border-border rounded-xl w-full max-w-md shadow-2xl">
        <div className="flex justify-between items-center px-5 py-4 border-b border-border">
          <h2 className="font-semibold text-primary">{project ? 'Projekt bearbeiten' : 'Neues Projekt'}</h2>
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div>
            <label className="text-xs text-secondary mb-1.5 block">Farbe</label>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <input type="color" value={color} onChange={e => setColor(e.target.value)}
                className="w-7 h-7 rounded-full cursor-pointer border-0 bg-transparent p-0" title="Eigene Farbe" />
            </div>
          </div>
          <div>
            <label className="text-xs text-secondary mb-1.5 block">Stundensatz (CHF)</label>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm text-primary">Abrechenbar</span>
          </label>
        </div>
